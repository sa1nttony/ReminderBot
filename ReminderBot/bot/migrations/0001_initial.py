# Generated by Django 5.0 on 2025-06-01 18:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(default='UTC', max_length=63, verbose_name='Часовой пояс')),
        ...
        migrations.AddField(
            model_name='chat',
            name='users',
            field=models.ManyToManyField(through='bot.ChatUser', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
